...
// job being approved or rejected, a password-reset link, a seeker's job-alert digest,
// and an interview being scheduled, rescheduled or cancelled. One place, so the site-name
